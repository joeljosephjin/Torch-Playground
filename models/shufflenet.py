...
# from blocks import idenUnit, poolUnit
...
class idenUnit(nn.Module):
    def __init__(self, input_channel, g):
        ...
        self.gconv1 = nn.Conv2d(
            input_channel, neck_channel, groups=g, kernel_size=1, bias=False
        )
        ...
        self.gconv2 = nn.Conv2d(
            neck_channel, input_channel, groups=g, kernel_size=1, bias=False
        )
...
class poolUnit(nn.Module):
    def __init__(
        self, input_channel, output_channel, g, first_group=True, downsample=True
    ):
        ...
        if first_group:
            ...
            self.gconv1 = nn.Conv2d(
                input_channel, neck_channel, kernel_size=1, bias=False
            )
...
class ShuffleNet(nn.Module):
    def __init__(self, output_size=10, scale_factor=0.5, g=1):
        ...
        # build stages
        self.stage2 = self.build_stage(
            24, c2, repeat_time=3, first_group=False, downsample=False
        )
